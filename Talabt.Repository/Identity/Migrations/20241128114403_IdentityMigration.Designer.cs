...
namespace Talabat.Repository.Migrations
{
    ...
    [Migration("20241128114403_IdentityMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabat.Core.Entities.identity.AddAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talabat.Core.Entities.identity.AddAddress", b =>
                {
                    b.HasOne("Talabat.Core.Entities.identity.AppUser", "User")
                        .WithOne("Addresses")
                        .HasForeignKey("Talabat.Core.Entities.identity.AddAddress", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
